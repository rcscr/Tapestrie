...
Searching the Linux manual (1,860 HTML pages and 21,181 unique tokens) for `computer` with `errorTolerance=2` takes ~3 seconds and will return HTML pages containing any of these hits:
